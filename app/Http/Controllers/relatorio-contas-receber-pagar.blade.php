            ...
            <div class="section-card filters-card mb-6 print:hidden">
                <form method="GET" class="filter-form">
                    <div class="filter-grid">
                        <div class="filter-group col-span-12 lg:col-span-3">
                        ...
                        <div class="filter-group col-span-12 lg:col-span-2">
                            <label class="filter-label">Inicio</label>
                            <input type="date" name="data_inicio" value="{{ $dataInicio ?? request('data_inicio') }}" class="filter-input" />
                        </div>

                        <div class="filter-group col-span-12 lg:col-span-2">
                            <label class="filter-label">Fim</label>
                            <input type="date" name="data_fim" value="{{ $dataFim ?? request('data_fim') }}" class="filter-input" />
                        </div>
