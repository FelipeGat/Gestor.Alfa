            ...
            function renderAbas() {
                ...
                const tabsHtml = tabs.map(tab => {
                    ...
                    const closeButton = isActive 
                        ? `<button type="button" onclick="event.stopPropagation(); window.fecharTab('${tab.id}')" class="ml-3 w-5 h-5 flex items-center justify-center rounded-full text-gray-400 hover:text-red-500 hover:bg-red-100 transition-colors text-xs leading-none">×</button>`
                        : `<button type="button" onclick="event.preventDefault(); event.stopPropagation(); window.fecharTab('${tab.id}')" class="ml-3 w-5 h-5 flex items-center justify-center rounded-full text-gray-400 hover:text-red-500 hover:bg-red-100 transition-colors text-xs leading-none opacity-0 group-hover:opacity-100">×</button>`;
