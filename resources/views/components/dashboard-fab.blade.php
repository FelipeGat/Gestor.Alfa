<div x-data="{ open: false }" class="fixed bottom-6 right-6 z-50">
    ...
    <div x-show="open" x-transition class="flex flex-col items-end space-y-3 mb-4">
        ...
        <a href="{{ route('dashboard.tecnico') }}" class="fab-menu-item">
        ...
        <a href="{{ route('dashboard.comercial') }}" class="fab-menu-item">
        ...
        <a href="{{ route('financeiro.dashboard') }}" class="fab-menu-item">
