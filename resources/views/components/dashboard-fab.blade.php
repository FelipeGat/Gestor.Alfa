...
<div x-data="{ open: false }" class="fixed bottom-6 right-6 z-50">
    ...
    <div x-show="open" x-transition class="flex flex-col items-end space-y-3 mb-4">
        @if($isAdmin)
            <a href="{{ route('dashboard') }}" class="fab-menu-item" data-tab-link data-tab-label="Dashboard Operacional" data-tab-icon="dashboard">
            ...
            <a href="{{ route('dashboard.tecnico') }}" class="fab-menu-item" data-tab-link data-tab-label="Dashboard Técnico" data-tab-icon="dashboard-tecnico">
            ...
            <a href="{{ route('dashboard.comercial') }}" class="fab-menu-item" data-tab-link data-tab-label="Dashboard Comercial" data-tab-icon="dashboard-comercial">
            ...
            <a href="{{ route('financeiro.dashboard') }}" class="fab-menu-item" data-tab-link data-tab-label="Dashboard Financeiro" data-tab-icon="financeiro">
