    ...
    <select
        ...
        class="w-full rounded-lg border shadow-sm px-3 py-2 text-sm transition-all duration-200
            {{ $hasError
                ...
                : 'border-gray-300 dark:border-gray-600 focus:border-[#3f9cae] focus:ring-[#3f9cae]/20' }}
            {{ $disabled ? 'bg-gray-100 dark:bg-gray-700 cursor-not-allowed' : 'bg-white dark:bg-gray-700 dark:text-gray-100' }}"
    >
        @if($placeholder)
