<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        <nav class="flex items-center gap-2 text-base font-semibold leading-tight rounded-full py-2">
            ...
            <a href="{{ route('usuarios.index') }}" class="text-gray-500 hover:text-gray-700 transition">Usuários</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
                ...
                <div class="bg-white shadow rounded-lg p-6 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="perfis[]" value="{{ $perfil->id }}" class="rounded-lg border-gray-300"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="empresas[]" value="{{ $empresa->id }}"
                                class="rounded-lg border-gray-300" @checked($usuario->empresas->contains($empresa->id))>
