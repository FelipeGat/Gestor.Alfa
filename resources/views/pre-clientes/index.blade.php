<x-app-layout>
    ...
    <style>
        ...
        /* Tabela */
        .tabela-pre-clientes thead th {
            color: rgb(17, 24, 39) !important;
            font-size: 14px;
            font-weight: 600;
        }
        .tabela-pre-clientes tbody td {
            font-weight: 400 !important;
            color: rgb(17, 24, 39) !important;
        }
        .tabela-pre-clientes tbody td.font-medium {
            font-weight: 400 !important;
            color: rgb(17, 24, 39) !important;
        }
        .tabela-pre-clientes tbody td:nth-child(1),
        .tabela-pre-clientes tbody td:nth-child(2),
        .tabela-pre-clientes tbody td:nth-child(3),
        .tabela-pre-clientes tbody td:nth-child(4),
        .tabela-pre-clientes tbody td:nth-child(5),
        .tabela-pre-clientes tbody td:nth-child(6),
        .tabela-pre-clientes tbody td:nth-child(7) {
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="GET" class="filters-card p-6">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                    <div class="flex flex-col lg:col-span-4">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="CPF/CNPJ, Razão Social ou Nome Fantasia" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#3f9cae] w-full">
                    </div>
                    ...
                    <div class="flex items-end gap-2 lg:col-span-3">
                        <button type="submit" class="btn" style="padding: 0.5rem 1rem; font-size: 0.875rem; line-height: 1.25rem; width: 130px; justify-content: center; background: #3f9cae; border-radius: 9999px; color: white; box-shadow: 0 2px 4px rgba(63, 156, 174, 0.3);" onmouseover="this.style.boxShadow='0 4px 6px rgba(63, 156, 174, 0.4)'" onmouseout="this.style.boxShadow='0 2px 4px rgba(63, 156, 174, 0.3)'">
                        ...
                        <a href="{{ route('pre-clientes.index') }}" class="btn" style="padding: 0.5rem 1rem; font-size: 0.875rem; line-height: 1.25rem; width: 130px; justify-content: center; background: #9ca3af; border-radius: 9999px; color: white; box-shadow: 0 2px 4px rgba(156, 163, 175, 0.3);" onmouseover="this.style.boxShadow='0 4px 6px rgba(156, 163, 175, 0.4)'" onmouseout="this.style.boxShadow='0 2px 4px rgba(156, 163, 175, 0.3)'">
                            <svg fill="currentColor" viewBox="0 0 20 20" class="w-4 h-4">
            ...
            <div class="bg-white rounded-lg overflow-hidden" style="border: 1px solid #3f9cae; border-top-width: 4px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                <div class="overflow-x-auto">
                    <table class="w-full table-auto tabela-pre-clientes">
                        <thead style="background-color: rgba(63, 156, 174, 0.05); border-bottom: 1px solid #3f9cae;">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left uppercase" style="font-size: 14px; font-weight: 600;">E-mail</th>
                                <th class="px-4 py-3 text-left uppercase" style="font-size: 14px; font-weight: 600;">Telefone</th>
                                <th class="px-4 py-3 text-left uppercase" style="font-size: 14px; font-weight: 600;">Origem</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex gap-1 items-center justify-center">
                                        <a href="{{ route('pre-clientes.edit', $preCliente) }}" class="btn btn-sm btn-edit" style="padding: 0.5rem; border-radius: 9999px; display: inline-flex; align-items: center; justify-content: center;" title="Editar">
