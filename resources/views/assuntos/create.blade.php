<x-app-layout>
    ...
    <x-page-title title="Novo Assunto" :route="route('assuntos.index')" />
            ...
            <form action="{{ route('assuntos.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white rounded-lg p-6 sm:p-8" style="border: 1px solid #3f9cae; border-top-width: 4px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div class="col-span-1 sm:col-span-2">
                            <x-form-input name="nome" label="Assunto" required placeholder="Ex: Pintura, Instalação de Ar Condicionado" />
                        </div>

                        <div>
                            <x-form-input name="categoria" label="Categoria" required placeholder="Ex: Acabamento, Refrigeração" />
                        </div>

                        <div>
                            <x-form-input name="subcategoria" label="SubCategoria" required placeholder="Ex: Reformas e Reparos" />
                        </div>
                    </div>
                </div>
