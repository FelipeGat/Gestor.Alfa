<x-app-layout>
    ...
    <style>
        ...
        .tabela-assuntos thead th {
            color: rgb(17, 24, 39) !important;
        }
        .tabela-assuntos tbody td {
            font-weight: 400 !important;
        }
        .tabela-assuntos tbody td.font-medium {
            font-weight: 400 !important;
        }
        .tabela-assuntos tbody td:nth-child(2),
        .tabela-assuntos tbody td:nth-child(3) {
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg overflow-hidden" style="border: 1px solid #3f9cae; border-top-width: 4px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                <div class="overflow-x-auto">
                    <table class="w-full table-auto tabela-assuntos">
                        <thead style="background-color: rgba(63, 156, 174, 0.05); border-bottom: 1px solid #3f9cae;">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left uppercase" style="font-size: 14px; font-weight: 600;">Assunto</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 text-sm whitespace-nowrap">
                                    <div class="flex gap-1 items-center">
                                        ...
                                        @if(auth()->user()->isAdminPanel() || auth()->user()->canPermissao('assuntos','excluir'))
