        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="pagination-wrapper">
                <div class="pagination-info">
                    Mostrando <strong>{{ $empresas->count() }}</strong> de
                ...
                <div class="pagination-links">
                    ...
                    @else
                    <a href="{{ $empresas->previousPageUrl() }}" class="pagination-link">← Anterior</a>
                    @endif
                    ...
                    <a href="{{ $empresas->nextPageUrl() }}" class="pagination-link">Próximo →</a>
                    @else
