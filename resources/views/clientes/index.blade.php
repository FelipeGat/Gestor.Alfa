    ...
    <div class="pb-8 pt-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="resumo-grid gap-4 mb-6" style="
                ...
                <div class="bg-white p-6 rounded-lg border-l-4 border-blue-600 w-full max-w-none" style="border-top: 1px solid #3f9cae; border-right: 1px solid #3f9cae; border-bottom: 1px solid #3f9cae; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                ...
                <div class="bg-white p-6 rounded-lg border-l-4 border-green-600 w-full max-w-none" style="border-top: 1px solid #3f9cae; border-right: 1px solid #3f9cae; border-bottom: 1px solid #3f9cae; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                ...
                <div class="bg-white p-6 rounded-lg border-l-4 border-red-600 w-full max-w-none" style="border-top: 1px solid #3f9cae; border-right: 1px solid #3f9cae; border-bottom: 1px solid #3f9cae; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                ...
                <div class="bg-white p-6 rounded-lg border-l-4 border-yellow-500 w-full max-w-none" style="border-top: 1px solid #3f9cae; border-right: 1px solid #3f9cae; border-bottom: 1px solid #3f9cae; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
