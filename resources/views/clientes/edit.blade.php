<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg rounded-lg px-6 py-4 sm:px-8 sm:py-6 mb-6">
                ...
                <div class="bg-white shadow rounded-lg p-6 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="col-span-1 sm:col-span-2">
                            ...
                            <input type="text" name="nome" value="{{ old('nome', $assunto->nome) }}" class="w-full rounded-lg border border-gray-300 shadow-sm
                ...
                <div class="bg-white shadow rounded-lg p-6 sm:p-8">
                    ...
                    <div class="max-w-xs">
                        ...
                        <select name="ativo" class="w-full rounded-lg border border-gray-300 shadow-sm
                            ...
                            <option value="1" @selected(old('ativo', $assunto->ativo))>
                                Ativo
                            </option>
                            <option value="0" @selected(!old('ativo', $assunto->ativo))>
                                Inativo
                            </option>
                        </select>
                    </div>
