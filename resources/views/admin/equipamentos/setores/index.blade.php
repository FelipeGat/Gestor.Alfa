    ...
    <div class="pb-8 pt-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-start gap-3">
                <x-button href="{{ route('admin.equipamentos.setores.create') }}" variant="success" size="sm">
                    ...
                    <x-table-cell :nowrap="true">
                        <div class="flex items-center gap-2">
                            @if(auth()->user()->canPermissao('equipamentos', 'ler'))
                                <a href="{{ route('admin.equipamentos.setores.show', $setor->id) }}" 
                            ...
                            @if(auth()->user()->canPermissao('equipamentos', 'excluir'))
                                <form action="{{ route('admin.equipamentos.setores.destroy', $setor->id) }}" 
                                      method="POST" 
                                      class="inline-block"
