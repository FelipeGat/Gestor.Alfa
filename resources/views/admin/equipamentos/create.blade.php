                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="setor_nome" name="setor_nome" type="text" class="mt-1 block w-full" :value="old('setor_nome')" placeholder="Ex: RH, TI, Produção..." />
                                <x-input-error :messages="$errors->get('setor_nome')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="responsavel_nome" value="Responsável" />
                                <x-text-input id="responsavel_nome" name="responsavel_nome" type="text" class="mt-1 block w-full" :value="old('responsavel_nome')" placeholder="Ex: João Silva" />
