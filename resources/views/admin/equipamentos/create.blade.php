                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-input id="modelo" name="modelo" type="text" class="mt-1 block w-full" :value="old('modelo')" />
                                <x-input-error :messages="$errors->get('modelo')" class="mt-2" />
                            </div>

                            <div>
                                <x-label for="fabricante" value="Fabricante" />
                                <x-input id="fabricante" name="fabricante" type="text" class="mt-1 block w-full" :value="old('fabricante')" />
                                <x-input-error :messages="$errors->get('fabricante')" class="mt-2" />
                            </div>

                            <div class="md:col-span-2">
                                <x-label for="numero_serie" value="Número de Série" />
                                <x-input id="numero_serie" name="numero_serie" type="text" class="mt-1 block w-full" :value="old('numero_serie')" />
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-input id="ultima_manutencao" name="ultima_manutencao" type="date" class="mt-1 block w-full" :value="old('ultima_manutencao')" />
                                <x-input-error :messages="$errors->get('ultima_manutencao')" class="mt-2" />
                            </div>

                            <div>
                                <x-label for="ultima_limpeza" value="Última Limpeza" />
                                <x-input id="ultima_limpeza" name="ultima_limpeza" type="date" class="mt-1 block w-full" :value="old('ultima_limpeza')" />
                            ...
                            <div>
                                ...
                                <x-input id="periodicidade_manutencao_meses" name="periodicidade_manutencao_meses" type="number" min="1" max="120" class="mt-1 block w-full" :value="old('periodicidade_manutencao_meses', 6)" />
                            ...
                            <div>
                                ...
                                <x-input id="periodicidade_limpeza_meses" name="periodicidade_limpeza_meses" type="number" min="1" max="120" class="mt-1 block w-full" :value="old('periodicidade_limpeza_meses', 1)" />
