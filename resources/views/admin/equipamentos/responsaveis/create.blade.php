            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                ...
                <form action="{{ route('admin.equipamentos.responsaveis.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-input id="cargo" name="cargo" type="text" class="mt-1 block w-full" :value="old('cargo')" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-input id="telefone" name="telefone" type="text" class="mt-1 block w-full" :value="old('telefone')" placeholder="(xx) xxxxx-xxxx" />
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
                        ...
                        <a href="{{ route('admin.equipamentos.responsaveis.index') }}" class="text-sm text-gray-600 hover:text-gray-900">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
