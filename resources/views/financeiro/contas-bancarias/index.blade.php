                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 text-left">
                                    <span class="inline-flex items-center justify-center h-8 px-3 rounded-full text-sm font-semibold w-32
                                ...
                                <td class="px-4 py-3 text-left">
                                    <div class="flex gap-1 items-center justify-start">
                                        <a href="{{ route('financeiro.contas-financeiras.edit', $conta) }}" class="btn btn-edit" title="Editar">
                                        ...
                                        <button type="button" class="btn btn-adjust" title="Ajuste Manual" onclick="abrirModalAjusteUnificado({{ $conta->id }}, '{{ $conta->nome }}', {{ $conta->saldo }})">
                                            <svg fill="currentColor" viewBox="0 0 20 20">
