            ...
            <div class="space-y-5">
                ...
                <div id="camposAjusteManual" class="p-4 rounded-xl border space-y-3 transition-all" style="background-color: rgba(63, 156, 174, 0.05); border-color: #3f9cae;">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex items-center justify-center p-3 border-2 border-white bg-white rounded-xl cursor-pointer transition-all" style="border-color: #d1d5db;" onmouseover="this.style.borderColor='#3f9cae'" onmouseout="this.style.borderColor='#d1d5db'">
